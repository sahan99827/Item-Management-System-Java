...
public class ItemUi extends JFrame{
     ...
     // cmbDoinMonth =new JComboBox();
      ...
      //Search
       ...
       // cmbDoinDay.addActionListener(  new ActionListener(){  public void actionPerformed(ActionEvent e){ DointroducedAP(e);  }  } );
       // cmbDoinMonth.addActionListener(  new ActionListener(){  public void actionPerformed(ActionEvent e){ DointroducedAP(e);  }  } );
      //  cmbDoinYear.addActionListener(  new ActionListener(){  public void actionPerformed(ActionEvent e){ DointroducedAP(e);  }  } );
...
public String getErrors(){
  String errors ="";
  if (item.getName() ==null) errors =errors +"\n invalid Name";
  if (item.getCode() ==null) errors =errors +"\n invalid Code";;
  if (item.getPricepurchase() == 0.0) errors =errors+"\n invalid Pricepurchase";
  if (item.getPricesale() ==0.0) errors =errors +"\n invalid pricesale";
  if (item.getRop() ==0) errors =errors +"\n invalid ROP";
  if (item.getQoh() ==0) errors =errors +"\n invalid QOH";
  if (item.getBrand() ==null) errors =errors +"\n Brand Not selected";
  if (item.getSubCategory() ==null) errors =errors +"\n SubCategory Not selected";
  if (item.getStatusItem() ==null) errors =errors +"\n StatusItem Not selected";
  if (item.getDointroduced() ==null) errors =errors +"\n selecte Dointroduced";
  return errors;
...
public String getUpdates(){
  ...
  item.setId( oldItem.getId() );
   ...
   if (dt != null) {
     ...
     txtDate = (JTextField) datDob.getDateEditor().getUiComponent();
     item.setDointroduced(doin);
     if (today.getYear() >= doin.getYear() && doin.equals(oldItem.getDointroduced())) {
       txtDate.setBackground(valid);
     } else {
